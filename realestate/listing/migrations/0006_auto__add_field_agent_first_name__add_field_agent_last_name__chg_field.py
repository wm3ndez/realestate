...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agent.first_name'
        db.add_column(u'listing_agent', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)

        # Adding field 'Agent.last_name'
        db.add_column(u'listing_agent', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)


        # Changing field 'Agent.user'
        db.alter_column(u'listing_agent', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))

    def backwards(self, orm):
        # Deleting field 'Agent.first_name'
        db.delete_column(u'listing_agent', 'first_name')

        # Deleting field 'Agent.last_name'
        db.delete_column(u'listing_agent', 'last_name')


        # User chose to not deal with backwards NULL issues for 'Agent.user'
        raise RuntimeError("Cannot reverse this migration. 'Agent.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Agent.user'
        db.alter_column(u'listing_agent', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
    ...
    models = {
        ...
        u'listing.attributelisting': {
            'Meta': {'ordering': "['order']", 'object_name': 'AttributeListing'},
            ...
            'order': ('django.db.models.fields.SmallIntegerField', [], {'default': '99'}),
