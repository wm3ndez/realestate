...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AttributeListing.order'
        db.add_column(u'listing_attributelisting', 'order',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=99),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AttributeListing.order'
        db.delete_column(u'listing_attributelisting', 'order')
